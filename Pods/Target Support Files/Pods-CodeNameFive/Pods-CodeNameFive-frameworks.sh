...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleMapDirectionLib/GoogleMapDirectionLib.framework"
  ...
  install_dsym "${PODS_ROOT}/ZendeskSupportProvidersSDK/SupportProvidersSDK.framework.dSYM"
  install_framework "${PODS_ROOT}/ZendeskSupportSDK/SupportSDK.framework"
  install_dsym "${PODS_ROOT}/ZendeskSupportSDK/SupportSDK.framework.dSYM"
fi
